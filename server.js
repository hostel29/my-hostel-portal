...
app.get('/', async (req, res) => {
    try {
        ...
        h += '<nav class="navbar navbar-expand-lg navbar-dark mb-4 shadow py-3"><div class="container"><a class="navbar-brand fw-bold text-warning fs-3" href="/">🏢 Hostel Surajpur</a><div class="navbar-nav ms-auto"><a class="nav-link btn btn-outline-warning text-white px-4 py-1.5 rounded-pill fw-bold" href="/view-students" target="_blank">🔒 Administrative Hub</a></div></div></nav>';
        h += '<div class="container"><div class="row mb-4"><div class="col-12 text-center"><button class="btn btn-danger fw-bold shadow px-5 py-3 rounded-pill text-warning fs-5" style="border: 2px solid #ffc107; background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%);" data-bs-toggle="modal" data-bs-target="#rulesModal">📜 छात्रावास आवश्यक नियम एवं अनिवार्य अनुशासन निर्देशिका ➔</button></div></div>';
        ...
        h += '<a href="https://wa.me/91' + warden.w1Mobile + '?text=नमस्ते सर, मुझे नए प्रवेश फॉर्म भरने में समस्या आ रही है, कृपया सहायता करें।" target="_blank" class="list-group-item list-group-item-action text-start fw-bold p-3 text-primary">➔ 📝 नए प्रवेश फॉर्म भरने में समस्या है</a>';
        h += '<a href="https://wa.me/91' + warden.w1Mobile + '?text=नमस्ते सर, मुझे डॉक्यूमेंट अपलोड करने में साइज का एरर आ रहा है, कृपया मदद करें।" target="_blank" class="list-group-item list-group-item-action text-start fw-bold p-3 text-primary">➔ 📂 दस्तावेज़ अपलोड (साइज) एरर है</a>';
        h += '<a href="https://wa.me/91' + warden.w1Mobile + '?text=नमस्ते सर, मेरा रूम अलॉटमेंट स्टेटस नहीं दिख रहा है, कृपया चेक कर दीजिए।" target="_blank" class="list-group-item list-group-item-action text-start fw-bold p-3 text-primary">➔ 🔍 रूम अलॉटमेंट / स्टेटस संबंधी प्रश्न</a>';
        h += '<a href="https://wa.me/91' + warden.w2Mobile + '?text=नमस्ते सर, मुझे छात्रावास नवीनीकरण फॉर्म (Renewal Form) की जानकारी चाहिए।" target="_blank" class="list-group-item list-group-item-action text-start fw-bold p-3 text-dark">➔ 🔄 नवीनीकरण फॉर्म (अधीक्षक-B से संपर्क करें)</a>';
...
// ⚡ फ़ाइल साइज वैलिडेशन स्क्रिप्ट (20KB से 150KB की कड़क शासकीय लिमिट)
...
app.get('/registration-form', (req, res) => {
    ...
    f += '<div class="col-md-12"><label class="form-label fw-bold text-danger">📂 छात्र का आधार कार्ड दस्तावेज़ (20-150KB, PDF/Images):</label><input type="file" name="studentAadharFile" class="form-control" onchange="validateFile(this)" required></div>';
...
app.get('/view-students', async (req, res) => {
    ...
    sList.forEach((s, idx) => {
        ...
        // 🔴🟢 [PERMANENT RED/GREEN MATRIX SYSTEM] अपलोड न होने पर लाइव लाल बटन चमकेगा!
