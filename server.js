...
app.get('/registration-form', (req, res) => {
    ...
    // ✅ Pre-Matric स्पेशल: कक्षा 6वीं से 10वीं तक ड्रॉपडाउन फिक्स
...
// 🔄 हॉस्टल नवीनीकरण फॉर्म (गूगल फॉर्म लिंक व 10वीं तक कक्षा फिक्स)
app.get('/renewal-form', async (req, res) => {
    ...
    // 📋 आधिकारिक ऑनलाइन नवीनीकरण आवेदन पत्र लिंक (Google Form Direct)
    rf += '<div class="alert alert-warning border-warning shadow-sm text-center mb-4"><h6 class="fw-bold mb-2 text-dark">📋 यदि आप नवीनीकरण आवेदन पत्र देखना/डाउनलोड करना चाहते हैं:</h6><a href="https://docs.google.com/forms/d/1o1MD6gL2gLhcnj3ipygBr1S52Q4oRQOhDyVTZQyIBWU/edit?chromeless=1" target="_blank" class="btn btn-sm btn-dark text-warning fw-bold px-4 py-2 rounded-pill shadow">📄 नवीनीकरण आवेदन पत्र (गूगल फॉर्म) खोलें ➔</a></div>';
    ...
    // ✅ Pre-Matric स्पेशल: कक्षा 6वीं से 10वीं तक सीमित किया
    rf += '<div class="col-md-6"><label class="form-label fw-bold text-primary">नई कक्षा जिसमें प्रवेश लिया है (10वीं तक):</label><select name="studentClass" class="form-select" required><option value="">कक्षा चुनें...</option><option value="6th">6वीं (Class 6th)</option><option value="7th">7वीं (Class 7th)</option><option value="8th">8वीं (Class 8th)</option><option value="9th">9वीं (Class 9th)</option><option value="10th">10वीं (Class 10th)</option></select></div>';
    
    rf += '<div class="col-md-6"><label class="form-label fw-bold">School का नाम:</label><input type="text" name="collegeName" class="form-control" required></div>';
    
    // ✅ नवीनीकरण आवेदन पत्र अपलोड (20KB - 150KB)
    rf += '<div class="col-md-12"><label class="form-label fw-bold text-danger">📄 नवीनीकरण आवेदन पत्र की फोटो/PDF अपलोड करें (20KB - 150KB):</label><input type="file" name="renewalAppFile" class="form-control" onchange="validateFile(this)" required></div>';
