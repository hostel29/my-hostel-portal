...
app.get('/', async (req, res) => {
    try {
        ...
        h += '<div class="card p-3 mb-4 border-start border-primary border-4 bg-white shadow-sm"><h6 class="fw-bold text-primary mb-1">ℹ️ छात्रावास परिचय</h6><p class="text-muted small mb-0">यह भव्य छात्रावास आदिम जाति तथा अनुसूचित जाति विकास विभाग, छत्तीसगढ़ शासन द्वारा संचालित है, जहाँ सूरजपुर जिले के सुदूर ग्रामीण अंचलों के प्रतिभावान छात्रों को निःशुल्क आवासीय एवं आधुनिक शैक्षणिक सुविधाएँ दी जाती हैं।</p></div>';
        h += '<div class="row g-4"><div class="col-md-8"><div class="logo-container shadow-sm"><img id="hostel-logo" src="" alt="Hostel Logo" class="logo-img"></div><div class="card p-3 mb-4 shadow-sm"><div class="card-header bg-danger text-white rounded mb-2 fw-bold fs-6">📢 लाइव आधिकारिक सूचना पट्ट (Notice Board)</div><ul id="live-notices" class="list-group list-group-flush"></ul></div><hr class="my-4 border-secondary opacity-25">';
        h += '<div class="row g-4 mb-5"><div class="col-md-6"><a href="/registration-form" class="premium-btn reg text-dark shadow-sm"><span style="font-size: 45px; display:block;" class="mb-2">📝</span><h4 class="fw-bold text-primary">ऑनलाइन प्रवेश पंजीकरण फॉर्म</h4><span class="badge bg-primary px-3 py-2 my-2 fs-6">सत्र 2026-27 (नवीन)</span><p class="text-muted small mb-0 mt-1">डिजिटल माध्यम से हॉस्टल एडमिशन अप्लाई करने हेतु यहाँ क्लिक करें</p></a></div>';
        h += '<div class="col-md-6"><a href="/check-status-page" class="premium-btn stat text-dark shadow-sm"><span style="font-size: 45px; display:block;" class="mb-2">🔍</span><h4 class="fw-bold text-success">डिजिटल प्रोफाइल / रूम अलॉटमेंट</h4><span class="badge bg-success px-3 py-2 my-2 fs-6">लाइव अलॉटमेंट रिजल्ट</span><p class="text-muted small mb-0 mt-1">अपना रूम नंबर, रसीद डाउनलोड और स्टेटस जाँचने हेतु यहाँ क्लिक करें</p></a></div></div></div>';
        
        h += '<div class="col-md-4"><div class="card p-3 text-center mb-4 border-top border-warning border-4 shadow-sm"><div class="card-header bg-light text-dark fw-bold rounded mb-3 border-0 fs-6">👨‍💼 छात्रावास प्रशासन प्रमुख (Warden Corner)</div><div class="row g-2"><div class="col-6 border-end"><img id="w1-img" src="" class="rounded border mb-2 shadow-sm" style="width: 90px; height: 90px; object-fit: cover;" onerror="this.src=\'https://via.placeholder.com/150\'\"><h6 id="w1-name" class="fw-bold text-dark mb-0 small"></h6><small id="w1-desig" class="text-muted block" style="font-size:10px;"></small><div class="text-start bg-light p-2 rounded border mt-2" style="font-size:10px;"><b>📞:</b> <span id="w1-phone"></span><br><b>🏢:</b> <span id="w1-office"></span></div></div><div class="col-6"><img id="w2-img" src="" class="rounded border mb-2 shadow-sm" style="width: 90px; height: 90px; object-fit: cover;" onerror="this.src=\'https://via.placeholder.com/150\'\"><h6 id="w2-name" class="fw-bold text-dark mb-0 small"></h6><small id="w2-desig" class="text-muted block" style="font-size:10px;"></small><div class="text-start bg-light p-2 rounded border mt-2" style="font-size:10px;"><b>📞:</b> <span id="w2-phone"></span><br><b>🏢:</b> <span id="w2-office"></span></div></div></div></div>';
        h += '<div class="card p-3 shadow-sm border-top border-success border-4"><div class="card-header bg-light text-success fw-bold rounded mb-2 border-0 fs-6 text-center">📋 छात्रावास फाइनल मेरिट चयन सूची</div><a href="/public-admission-list" target="_blank" class="btn btn-sm btn-success w-100 fw-bold py-2 mt-1 rounded-3">चयनित छात्रों की सूची देखें ➔</a></div></div></div></div>';
        
        h += '<a id="whatsapp-link" href="#" target="_blank" class="whatsapp-float">💬 आधिकारिक वॉर्डन सहायता केंद्र</a>';
        h += '<div class="modal fade" id="rulesModal" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-lg"><div class="modal-content text-dark"><div class="modal-header bg-danger text-white"><h5 class="modal-title fw-bold text-warning">📜 शासकीय छात्रावास अनिवार्य नियम एवं अनुशासन नियमावली</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div><div class="modal-body p-4" style="font-size: 15px; line-height: 1.8;"><ol class="fw-bold text-secondary"><li class="mb-2">छात्रावास में चयनित प्रत्येक छात्र को मेस (भोजन व्यवस्था) में सम्मिलित होना तथा नियमों का पालन करना अनिवार्य है।</li><li class="mb-2">स्थानीय शिक्षण संस्थान (स्कूल/कॉलेज) में छात्र की नियमित उपस्थिति न्यूनतम 75% होना अनिवार्य है।</li><li class="mb-2">बिना अधीक्षक की लिखित अनुमति के छात्रावास से अनुपस्थित रहने पर तत्काल प्रभाव से निष्कासित किया जाएगा।</li><li class="mb-2">किसी भी बाहरी या अप्रवेशी व्यक्ति को छात्रावास परिसर में ठहराना पूर्णतः वर्जित एवं दण्डनीय अपराध है।</li><li class="mb-2">परिसर के भीतर किसी भी प्रकार के मादक पदार्थ या अनुशासनहीनता पाए जाने पर बिना नोटिस निष्कासन की कार्रवाई की जाएगी।</li></ol></div><div class="modal-footer"><button type="button" class="btn btn-secondary fw-bold" data-bs-dismiss="modal">मैंने नियम पढ़ लिए हैं</button></div></div></div></div>';
...
app.get('/edit-student-form', async (req, res) => {
    try {
        ...
        let editHtml = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>त्रुटि सुधार</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"></head><body class="p-4 bg-light"><div class="container" style="max-width: 900px;"><div class="card p-4 bg-white border border-warning shadow-sm"><h2 class="text-center text-warning fw-bold mb-4">🛠️ आवेदन पत्र में त्रुटि सुधार</h2><form action="/submit-form" method="POST" enctype="multipart/form-data" class="row g-3">';
        editHtml += '<input type="hidden" name="mobile" value="' + student.mobile + '"><input type="hidden" name="existingPhoto" value="' + student.photoUrl + '">';
        ...
        editHtml += '<div class="col-md-6"><label class="form-label fw-bold">आधार नंबर:</label><input type="text" name="aadharCard" class="form-control" value="' + (student.aadharCard || '') + '" required></div>';
        ...
        editHtml += '<div class="col-md-4"><label class="form-label fw-bold">वर्तमान कक्षा:</label><input type="text" name="studentClass" class="form-control" value="' + (student.studentClass || '') + '" required></div>';
        editHtml += '<div class="col-md-4"><label class="form-label fw-bold">शाला का नाम:</label><input type="text" name="collegeName" class="form-control" value="' + (student.collegeName || '') + '" required></div>';
        editHtml += '<div class="col-md-4"><label class="form-label fw-bold">पिछला प्रतिशत (%):</label><input type="text" name="prevPercent" class="form-control" value="' + (student.prevPercent || '') + '" required></div>';
        editHtml += '<div class="col-12"><label class="form-label text-danger">📸 नई फोटो (यदि बदलना चाहें):</label><input type="file" name="studentPhoto" class="form-control" accept="image/*"></div>';
        editHtml += '<div class="col-12 mt-4"><button type="submit" class="btn btn-warning w-100 text-dark fw-bold">🔄 जानकारी सुरक्षित करें</button></div></form></div></div></body></html>';
        res.send(editHtml);
    } catch(err) { res.status(500).send("Error"); }
});

// 🎫 [GRAND DIGITAL RECEIPT] बारकोड लुक और ऑफिशियल वाटरमार्क वाली भव्य रसीद (✨ No Backticks Engine)
app.get('/get-receipt-view', async (req, res) => {
    try {
        ...
        rc += '<div class="row border-bottom pb-3 mb-4 align-items-center"><div class="col-2 text-center"><img src="https://via.placeholder.com/80?text=GOVT" class="img-fluid"></div><div class="col-8 text-center"><h6 class="text-secondary fw-bold mb-0" style="font-size:12px; letter-spacing:1px;">आदिम जाति तथा अनुसूचित जाति विकास विभाग, छत्तीसगढ़ शासन</h6><h4 class="fw-bold text-dark my-1" style="font-family:\'Georgia\',serif;">प्री मैट्रिक ST+SC बालक छात्रावास सूरजपुर</h4><span class="badge bg-dark px-3 py-1 text-warning fw-bold" style="font-size:11px;">🔒 ऑफिशियल डिजिटल पावती रसीद (सत्र 2026-27)</span></div><div class="col-2 text-center"><div class="stamp">DIGITAL<br>VERIFIED</div></div></div>';
        rc += '<div class="row mb-4"><div class="col-8"><h5 class="fw-bold text-primary mb-3">🎫 कोड रसीद संख्या: <span class="text-danger">' + sData.appNo + '</span></h5><p class="mb-2"><b>विद्यार्थी का नाम (Name):</b> ' + sData.studentName + '</p><p class="mb-2"><b>पिता का नाम (Father):</b> ' + sData.fatherName + '</p><p class="mb-2"><b>पंजीकृत मोबाइल (Mobile):</b> +91 ' + sData.mobile + '</p><p class="mb-2"><b>कैटेगरी / वर्ग (Category):</b> ' + sData.category + ' (' + (sData.subCast || 'ST') + ')</p></div><div class="col-4 text-end"><img src="' + sData.photoUrl + '" class="img-thumbnail shadow-sm mb-2" style="width: 130px; height: 140px; object-fit: cover;" onerror="this.src=\'https://via.placeholder.com/150\'\"><div>' + badge + '</div></div></div>';
        rc += '<table class="table table-bordered bg-light" style="font-size:14px;"><tr><th class="bg-dark text-white" style="width:35%;">वर्तमान कक्षा/वर्ष</th><td>' + sData.studentClass + ' (' + (sData.course || 'N/A') + ')</td></tr><tr><th class="bg-dark text-white">अध्ययनरत शाला/संस्थान</th><td>' + sData.collegeName + '</td></tr><tr><th class="bg-dark text-white">घर से शाला की दूरी / पता</th><td>' + sData.homeDistance + ' KM - ' + sData.permanentAddress + ', ' + sData.blockName + ' (' + sData.districtName + ')</td></tr><tr><th class="bg-dark text-white">आबंटित रूम नंबर (Room)</th><td><b class="text-danger fs-5">' + (sData.roomNumber || 'अभी अलॉट नहीं हुआ') + '</b></td></tr><tr><th class="bg-dark text-white">डिजिटल सबमिशन टाइम</th><td>' + sData.date + '</td></tr></table>';
        rc += '<div class="border-top pt-3 mt-4 text-center"><div class="mb-2 text-muted" style="font-size:10px; font-family:\'Courier New\';">||||| Barcode Verified Data Sync ||||| ' + sData.aadharCard + '</div><p class="small text-muted mb-0">यह रसीद कंप्यूटर जनित है, इसमें किसी भौतिक हस्ताक्षर की आवश्यकता नहीं है।</p></div><div class="text-center mt-4 no-print"><button onclick="window.print()" class="btn btn-primary fw-bold px-4 me-2">🖨️ रसीद प्रिंट / PDF सेव करें</button><a href="/" class="btn btn-secondary px-4">🏠 मुख्य पृष्ठ पर जाएँ</a></div></div></div></body></html>';
