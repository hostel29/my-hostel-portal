...
try {
    ...
    console.log("ℹ️ Live environment configurations initialized.");
}
...
app.get('/view-students', async (req, res) => {
    ...
    let rows = '';
    // सत्र ऑटो-क्लीनअप सक्रिय: live सूची में केवल वर्तमान एक्टिव सत्र के छात्र दिखाई देंगे
